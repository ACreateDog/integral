...
<section>
    ...
    <div class="leftpanel">
        ...
        <div class="leftpanelinner">
            ...
            <ul class="nav nav-pills nav-stacked nav-bracket">
                ...
                <li id="news"><a href="/Integral/index.php/Admin/News/news"><i class="fa fa-th-list"></i> <span>通知公告</span></a></li>
                ...
                <li id="index"><a href="/Integral/index.php/Admin/index"><i class="fa fa-home"></i> <span>友情提示</span></a></li>
            </ul>
        </div><!-- leftpanelinner -->
    </div><!-- leftpanel -->
    ...
    <?php echo ($var); ?>
    <form class="form-horizontal form-bordered" action="sendNews" method="post">

        <div class="form-group">
            <label class="col-sm-3 control-label">填写通告</label>
            <div class="col-sm-7">
                <textarea class="form-control" name="content" rows="5" style="margin: 0px -17.5938px 0px 0px; height: 112px; width: 490px;"></textarea>
            </div>
        </div>
