    ...
    public function _empty($action='tables')
    {
      ...
      // /
       ...
       $list = $tables->where($filter)->order('sc_term desc')->limit($Page->firstRow.','.$Page->listRows)->select();
        // $parameter = null;
        // if($search['c_name'] != ""){
        //     $parameter = $parameter.'c_name like'.'"'.$search['c_name'].'%"';
        // }elseif($search['sc_term'] != ""){
        //     if($parameter != null){
        //         $parameter = $parameter.'and sc_term like'.'"'.$search['sc_term'].'%"';
        //     }else{
        //         $parameter = ' sc_term like'.'"'.$search['sc_term'].'%"';
        //     }
        // }elseif($search['sc_union'] != ""){
        //     if($parameter != null){
        //         $parameter = $parameter.'and sc_union like'.'"'.$search['sc_union'].'%"';
        //     }else{
        //         $parameter = ' sc_union like'.'"'.$search['sc_union'].'%"';
        //     }
        // }
        // $list = $tables->where($parameter)->order('sc_term desc')->limit($Page->firstRow.','.$Page->listRows)->select();
        if($action == 'export'){
            if(!$list){
